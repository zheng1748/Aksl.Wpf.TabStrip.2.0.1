...
namespace Aksl.Modules.ExpandHamburgerMenuTab.ViewModels
{
    public class ExpandHamburgerMenuTabHubViewModel : BindableBase, INavigationAware
    {
        #region Members
        ...
        #region Constructors
        public ExpandHamburgerMenuTabHubViewModel()
        {
