...
{
    public class ExpandHamburgerMenuSubHubViewModel : BindableBase, INavigationAware
    {
        #region Members
        ...
        private ViewElementManager _viewElementManager;
        #endregion

        #region Constructors
        public ExpandHamburgerMenuSubHubViewModel()
        {
            ...
            _viewElementManager= _container.Resolve<ViewElementManager>();
        ...
        {
            get => _viewElement;
            set => SetProperty<DependencyObject>(ref _viewElement, value);
        }
            ...
            buildHWorkspaceViewEvent.Subscribe(async (bmve) =>
            {
                ...
                try
                {
                    ...
                    async Task LoadViewAsync()
                    {
                        ...
                        {
                            var currentView = _viewElementManager.GetStoreViewElementType(viewType);
                            ...
                            if (currentView is not null)
                            {
                                ...
                                {
                                    _viewElementManager.Remove(currentView);

                                    ViewElement = _viewElementManager.Add(miniMenuItem);
                                }
                            }
                            else
                            {
